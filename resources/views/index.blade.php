...
<head>
    ...
    {{-- datagrid --}}
    <link href="{{url('/assets/eui/css/easyui.css')}}" rel="stylesheet">
    <script src="{{url('/assets/eui/js/jquery.easyui.min.js')}}"></script>
    <script src="{{url('/assets/eui/js/datagrid-filter.js')}}"></script>
