                        ...
                        <div class="col-lg-4 col-md-6 d-flex flex-column align-items-center justify-content-center">
                            ...
                            <div class="card mb-3">
                                ...
                                <div class="card-body">
                                    ...
                                    <form class="row g-3 needs-validation" action="{{ route('recovery_action') }}"
                                        method="POST">
                                        @csrf
                                        <div class="col-12 text-center">
                                            <p>Masukan Nomor Handphone yang telah didaftarkan.
                                            </p>
                                        </div>
                                        <div class="col-12 text-center">
                                            <label for="akses" class="form-label">No Handphone</label>
                                            <input type="text" name="handphone" class="form-control" id="handphone"
                                                required="required">
                                            <div class="invalid-feedback">No Handphone Tidak Valid</div>
                                        </div>
                                        <div class="col-12">
